...
func (c *ConsumerGroup) Consume(ctx context.Context, topic string, handler sarama.ConsumerGroupHandler) error {
	return c.Consumer.Consume(ctx, []string{topic}, handler)
}
